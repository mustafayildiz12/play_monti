...
import 'package:play_monti/screens/Auth/forgot_password_screen.dart';
import 'package:play_monti/screens/Auth/login_screen.dart';
import 'package:play_monti/screens/Auth/register_page.dart';
import 'package:play_monti/screens/ExcelActivity/activities_screen.dart';
...
class AppPages {
  static List<GetPage<dynamic>>? pages = [
    GetPage(
        name: AppRoutes.activityTable, page: () => const ActivitiesTablePage()),
    GetPage(
        name: AppRoutes.uploadActivityPage,
        page: () => const UploadActivityExcel()),
    GetPage(
